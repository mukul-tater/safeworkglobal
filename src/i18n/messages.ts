...
const en = {
  ...
  "header.findJobSub": "Continue as a Worker",
  "header.hire": "Hire workers",
  "header.hireSub": "Continue as an Employer",
  ...
  "header.findJobCta": "Find a job",
  "header.hireCta": "Hire workers",
  ...
  "hero.workerTitle3": "🇮🇳 भारत का हुनर, दुनिया में पहचान।",
  ...
  "partner.already": "Continue with an existing partner account?",
...
const hi: Record<AppMessageKey, string> = {
  ...
  "header.findJobSub": "श्रमिक के रूप में जारी रखें",
  "header.hire": "श्रमिक भर्ती करें",
  "header.hireSub": "नियोक्ता के रूप में जारी रखें",
  ...
  "header.findJobCta": "नौकरी पाएँ",
  "header.hireCta": "श्रमिक भर्ती करें",
