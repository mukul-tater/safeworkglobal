...
const SKILL_ALIASES: Array<{ skill: (typeof WORKER_SKILLS)[number]; needles: string[] }> = [
  ...
  { skill: 'Helper', needles: ['construction labour', 'construction helper', 'civil helper', 'warehouse', 'supermarket', 'scaffolder', 'painter', 'cleaner', 'housekeeping', 'janitor', 'helper', 'labour', 'labor'] },
];
