            ...
            <div className="flex items-start justify-between mb-2">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Keep company details accurate. Document KYC upload will be added later — do not treat demo badges as verified.
                </p>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                {fieldErrors.company_name && (
                  <p className="text-sm text-destructive mt-1">{fieldErrors.company_name}</p>
                )}
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {fieldErrors.industry && (
                    <p className="text-sm text-destructive mt-1">{fieldErrors.industry}</p>
                  )}
                </div>
              </div>
              <div>
                ...
                {fieldErrors.company_size && (
                  <p className="text-sm text-destructive mt-1">{fieldErrors.company_size}</p>
                )}
              </div>
              <div>
