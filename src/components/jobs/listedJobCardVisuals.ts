...
export const UAE_LISTED_JOB_CARD_VISUALS: Record<UaeListedJob, { image: string; position?: string }> = {
  ...
  'MIG Welder': { image: welderImg, position: 'center 22%' },
  'TIG Welder': { image: welderImg, position: 'center 22%' },
  ...
  'Mason (bricks/plaster)': { image: masonImg, position: 'center 55%' },
  ...
  'Cleaner (Male)': { image: labourImg, position: 'center 30%' },
  'Cleaner (Female)': { image: warehouseImg, position: 'center 40%' },
