    ...
    <header className="sticky top-0 z-40 w-full border-b bg-card/95 backdrop-blur-md supports-[backdrop-filter]:bg-card/80">
      <div className="flex h-14 md:h-16 items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-3 ml-12 md:ml-0">
          ...
          <h2 className="text-base md:text-lg font-semibold text-foreground">Worker Portal</h2>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56" align="end" forceMount>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => navigate("/worker/profile")} className="cursor-pointer">
                <User className="mr-2 h-4 w-4" />
                <span>My Profile</span>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => navigate("/worker/notifications")} className="cursor-pointer">
